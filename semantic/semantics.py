...
class ImageNet21kSemanticSoftmax:
    def __init__(self, args):
        ...
        # for i in range(20):
        #     print(f"class_tree_list[{i}]:")
        #     for j in range(len(self.class_tree_list[i])):
        #         print(f"  {self.class_tree_list[i][j]}")
        self.class_names = np.array(list(self.tree['class_description'].values()))
        # print("class_tree_list len:", len(self.class_tree_list))
        # print("class_names len:", len(self.class_names))
    ...
    def convert_targets_to_semantic_targets(self, targets_original: Tensor) -> Tensor:
        ...
        # print("semantic_targets_list.shape:", semantic_targets_list.shape)
